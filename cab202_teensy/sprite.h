 ...
 *	via parameters, the horizontal and vertical step sizes are set to 0.0, and
 *	the sprite is made visible.
 *
 *	Parameters:
 *		sprite -  the address of a Sprite which is to be initialised.
 ...
 *			the original bitmap is retained. Changes to that bitmap are
